...
public class SWGridController implements GridController {
	...
	private SWGridTextInterface gridText;
	...
	public SWGridController(SWWorld world) {
		...
		gridText = new SWGridTextInterface(this.grid);
	...
	public SWGridTextInterface getGridText() {
		return this.gridText;
	}
	
	public static void setTextUi(SWGridController g) {
		SWGridController.ui = g.gridText;
	}
