...
//		SWGridTextInterface.grid = grid;
	...
	/**
	 * Setting the static grid to the thisGrid
	 * 
	 * @param g SWGridTextInterface of the world
	 */
	public static void setGrid(SWGridTextInterface g) {
		SWGridTextInterface.grid = g.thisGrid;
	}
