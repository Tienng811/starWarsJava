...
public class SWWorld extends World {
	private SWGridController uiController;
	/**
	 ...
	 * and the grid.
	 * 
	 * @param gridSize the grid size of the world
	 */
	public SWWorld(int gridSize) {
		SWLocation.SWLocationMaker factory = SWLocation.getMaker();
		//Added a gridSize parameter to specify how big the grid is
		myGrid = new SWGrid(factory, gridSize);
		space = myGrid;
		
	}
	
	public void setGridController(SWGridController g){
		uiController = g;
	}
	
	public SWGridController getGridController(){
		return uiController;
	}
	
	public SWGrid getMyGrid() {
		return myGrid;
	}
	...
	public void initializeWorld(MessageRenderer iface) {
		...
		//Droid 1
		Droid r2d2 = new Droid(Team.GOOD, 100, iface, this, ben);
		r2d2.setShortDescription("R2D2 Droid");
		r2d2.setSymbol("R");
		loc = myGrid.getLocationByCoordinates(1, 1);
		entityManager.setLocation(r2d2, loc);
		
		//Droid 2
		Droid bb8 = new Droid(Team.NEUTRAL, 100, iface, this, null);
		bb8.setShortDescription("BB8 Droid");
		bb8.setSymbol("8");
		loc = myGrid.getLocationByCoordinates(7, 5);
		entityManager.setLocation(bb8, loc);
		
		//Jawa Sandcrawler 1
		JawaSandcrawler jawaOne = new JawaSandcrawler(Team.NEUTRAL, 100, iface, this, patrolmoves);
		jawaOne.setShortDescription("Jawa Sandcrawler One");
		jawaOne.setSymbol("J1");
		loc = myGrid.getLocationByCoordinates(5, 4);
		entityManager.setLocation(jawaOne, loc);
		
		//Jawa Sandcrawler 2
		JawaSandcrawler jawaTwo = new JawaSandcrawler(Team.NEUTRAL, 100, iface, this, patrolmoves);
		jawaTwo.setShortDescription("Jawa Sandcrawler Two");
		jawaTwo.setSymbol("J2");
		loc = myGrid.getLocationByCoordinates(2, 2);
		entityManager.setLocation(jawaTwo, loc);
