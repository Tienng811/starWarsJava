...
public class AttackNeighbours {
	...
	public static NeighbourInformation attackLocals(SWActor actor, SWWorld world, boolean avoidFriendlies, boolean avoidNonActors) {
		...
		ArrayList<NeighbourInformation> attackables = new ArrayList<NeighbourInformation>();
			...
			if( e != actor && 
				...
				for (Affordance a : e.getAffordances()) {
					if (a instanceof Attack) {
						...
						attackables.add(new NeighbourInformation(e, a));
						break;
					}
				}
			}
